...
#define OS_TICKS_PER_SEC        100    /* Set the number of ticks in one second                        */
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    1024    /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   1024    /* Statistics task stack size (# of OS_STK wide entries)        */
